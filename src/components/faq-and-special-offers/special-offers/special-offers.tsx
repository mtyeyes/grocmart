...
const SpecialOffers: React.FC = () => {
  ...
  const getLoadedData = (requestResults: {'products-of-the-day': string[]}) => { setSpecialOffers(requestResults['products-of-the-day']) };
  ...
  return (
    <div className="specials-slider__wrapper">
      <Loader requests={ {resourceRequests: ['products-of-the-day'], stateRequests: ['products', 'discounts']} } transferRequestedResources={getLoadedData}>
